  ...
  return (
    <section style={{ maxWidth: 1100, margin: "0 auto", padding: "120px 48px 80px", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 64, alignItems: "center" }}>
      ...
      <div className="animate-fade-up">
        ...
        {/* Headline */}
        <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(46px, 5vw, 68px)", fontWeight: 600, lineHeight: 1.06, letterSpacing: "-1.5px", color: "var(--ink)", marginBottom: 22 }}>
