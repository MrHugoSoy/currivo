        ...
        {stats.map((s, i) => (
          <div key={s.n} style={{ display: "flex", alignItems: "center", gap: 48 }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 36, fontWeight: 600, letterSpacing: "-1px", color: "#fff", lineHeight: 1 }}>{s.n}</span>
              <span style={{ fontSize: 13, color: "rgba(255,255,255,0.4)" }}>{s.l}</span>
            </div>
