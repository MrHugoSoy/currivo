...
export const metadata: Metadata = {
  title: "Términos y Condiciones · resumika.com",
  description: "Términos y condiciones de uso del servicio resumika.com — generador de CVs con inteligencia artificial.",
};
      ...
      <div style={{ maxWidth: 740, margin: "0 auto", padding: "56px 48px 80px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 36 }}>
          ...
          <Section title="1. Aceptación de los términos">
            <P>Al acceder o utilizar resumika.com ("el Servicio"), usted acepta quedar vinculado por estos Términos y Condiciones. Si no está de acuerdo con alguna parte de estos términos, no podrá acceder al Servicio.</P>
          ...
          <Section title="2. Descripción del servicio">
            <P>resumika.com es una plataforma en línea que utiliza inteligencia artificial para generar currículums vitae profesionales. El Servicio permite a los usuarios:</P>
            <ul style={ulStyle}>
          ...
          <Section title="4. Contenido generado por IA">
            <P>Los currículums son generados por un modelo de inteligencia artificial (Anthropic Claude). resumika.com no garantiza que el contenido generado sea preciso, completo, libre de errores o adecuado para una vacante específica.</P>
            <P><strong>Es responsabilidad exclusiva del usuario</strong> revisar, corregir y validar el contenido antes de enviarlo a un reclutador o empleador. resumika.com no se hace responsable de decisiones de contratación tomadas con base en los CVs generados.</P>
          </Section>
          ...
          <Section title="5. Uso aceptable">
            ...
            <P>resumika.com se reserva el derecho de suspender o cancelar cuentas que incumplan estas condiciones, sin previo aviso y sin responsabilidad.</P>
          </Section>

          <Section title="6. Propiedad intelectual">
            <P>El diseño, código, marca y contenido editorial de resumika.com son propiedad de sus desarrolladores y están protegidos por las leyes de propiedad intelectual aplicables en México.</P>
          ...
          <Section title="7. Pagos y reembolsos">
            <P>Los planes de pago se cobran de forma adelantada al inicio de cada período de facturación. resumika.com no ofrece reembolsos por períodos parciales, salvo cuando la ley mexicana aplicable lo exija expresamente.</P>
