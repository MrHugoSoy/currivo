...
export default function TextEditor({ slug, nombre, puesto, initialText, templateId, mercado }: Props) {
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "var(--cream)", fontFamily: "'DM Sans','Nunito Sans',sans-serif" }}>
      ...
      {/* ── Top header — full width, inner content alineado a 1320px ── */}
      <header style={{
        flexShrink: 0,
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8, flexShrink: 0, alignItems: "center" }}>
            <a
              ...
              style={{ fontSize: 12, color: "var(--muted)", textDecoration: "none", border: "1px solid var(--border)", borderRadius: 6, padding: "7px 14px", whiteSpace: "nowrap" }}
            >
              Regenerar con IA →
            </a>
            <button
